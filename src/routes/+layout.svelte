...
<footer class="bg-white dark:bg-gray-900 w-full text-center border-t border-gray-100 shadow sm:flex sm:items-center sm:justify-between p-4 dark:border-gray-700">
	<span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">
		© 2023 <a href="https://devstar.com/" class="hover:underline">Developerstar™</a>. All Rights Reserved.
	</span>
...
<style>
	main {
		padding-top: 5rem; /* Add padding to ensure content is visible below the fixed header */
	}
</style>
